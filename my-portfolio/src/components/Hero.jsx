...
.hero-photo-card {
  ...
  max-width: 420px;
  border-radius: 20px;
  overflow: visible; /* changed from hidden so shadow isn't clipped */
  background: transparent; /* removed dark bg */
...
.hero-photo-card img {
  ...
  /* shadow behind the image itself */
  filter: drop-shadow(0px 20px 60px rgba(120, 80, 255, 0.5))
          drop-shadow(0px 0px 30px rgba(180, 120, 255, 0.3));
}
      ...
      <section className="hero">
        ...
        <div className="hero-left">
          ...
          <motion.div className="hero-social" {...fu(0.52)}>
           ...
           {[ 
              { Icon: GithubIcon, link: "https://github.com/AsifMia-dev", name: "GitHub" },
              { Icon: LinkedinIcon, link: "https://linkedin.com/in/yourusername", name: "LinkedIn" },
              { Icon: Facebook, link: "https://www.facebook.com/asifmia.dev", name: "Facebook" },
              { Icon: LeetCode, link: "https://leetcode.com/u/asifmia/", name: "LeetCode" }
